package com.warys.scrooge.android.authentication;
...
import com.warys.scrooge.android.common.consumer.RestClientBuilder;
...
public class LoginActivity extends AbstractActivity {
    ...
    private final RestClient client = new RestClientBuilder()
            ...
            .buildInitalized();
    private PublicUsersApiService usersApiService = client
            .getPublicUsersApiService();
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            final Single<LoginResponse> responseSingle = usersApiService
                    .login(new LoginRequest(mEmail, mPassword));

            final Consumer<LoginResponse> loginResponseConsumer = new Consumer<LoginResponse>() {
                @Override
            ...
            responseSingle.subscribe(loginResponseConsumer, throwableConsumer).dispose();
